...
OPERATORS = [Operator("Require SexEd in Schools.",
                      lambda s, v, c: can_apply(s,v,0,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.01, -3, 0, True),
             Operator("Support Planned Parenthood.",
                      lambda s, v, c: can_apply(s,v,None,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.01, -3, None, True),
             Operator("Increase investment in technology sector of domestic economy.",
                      lambda s, v, c: can_apply(s,v,None,True,c), lambda s, g, c, u: apply_op(s, g, c, u), 0.0015, -3, None, True),
             Operator("One-Child Policy.",
                      lambda s, v, c: can_apply(s,v,3,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.15, -7, 3, True),
             Operator("Universal access to safe contraceptives.",
                      lambda s, v, c: can_apply(s,v,4,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.1, -10, 4, True),
             Operator("Guarantee secondary education, especially for girls.",
                      lambda s, v, c: can_apply(s,v,5,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.001, -3, 5, True),
             Operator("Eradicate gender bias from law, economic opportunity, health, and culture.",
                      lambda s, v, c: can_apply(s,v,6,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.0025, -1, 6, True),
             Operator("End policies that offer financial incentives based on number of children.",
                      lambda s, v, c: can_apply(s,v,7,True,c), lambda s, g, c, u: apply_op(s, g, c, u), -0.075, 0, 7, True),
             ...
             Operator("Invest into machinery and manufacturing.",
                      lambda s, v, c: can_apply(s, v, None, False,c), lambda s, g, c, u: apply_op(s, g, c, u), 0.05, -8, None, False),
             Operator("Invest into health sector.",
                      lambda s, v, c: can_apply(s, v, None, False,c), lambda s, g, c, u: apply_op(s, g, c, u), 0.1, -10, None, False),
             Operator("Promote Family Farms.",
                      lambda s, v, c: can_apply(s, v, None, False, c), lambda s, g, c, u: apply_op(s, g, c, u), 0.0015, 3, None, False),
             ...
             Operator("Work with religious organization to spread beliefs on family values.",
                      lambda s, v, c: can_apply(s, v, None, False,c), lambda s, g, c, u: apply_op(s, g, c, u), 0.0075, -1, None, False),
